...
class Fraction {
  ...
  public Fraction(int n) {
    this(n, 1);  // I think here this(n, 1) means Fraction(n, 1)
  }
  ...
  public Fraction(Fraction original) {
    this(original.numerator, original.denominator);  //  object orientation just like Python
	/*
	numberOfFractions++;
    numerator = 0;
    denominator = 1;
  ...
  public String toString() {
    int thisGcd = gcd(numerator, denominator);  // greatest common divisor
