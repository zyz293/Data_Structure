...
public class SList {
  ...
  public void insertFront(Object obj) {  // you should define what head is and what tail is.
	if (head == null) {
...
//		tail.prev = node;
  ...
  private static void testlab() {
	  ...
	  System.out.println("Here is the same list after insertFront(3) and insertEnd(15): "
				+ lst1.toString());
	  TestHelper.verify(lst1.toString().equals("[  3  6  9  12  15  ]"),
				"insertFront and insertEnd failed");
  }
}