...
//	  stringInts(results);
  ...
  public static void main(String[] args) {
    ...
    TestHelper.verify(result.equals("[  ]"),
                      "BAD SQUISH!!!  No biscuit.");
	int[] test10 = {0, 1, 2, 3, 4, 5, 6, 6};
    SList list10 = new SList();
    for (i = 0; i < test10.length; i++) {
      list10.insertEnd(new Integer(test10[i]));
    }
    System.out.println("squishing " + list10.toString() + ":");
    list10.squish();
    result = list10.toString();
    System.out.println(result);
